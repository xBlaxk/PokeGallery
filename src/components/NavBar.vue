    ...
    <nav class="border-gray-200 bg-white dark:bg-gray-900">
        <div class="mx-auto flex max-w-screen-xl flex-wrap items-center justify-between p-4">
            <a href="/" class="flex items-center">
                <img src="@/assets/pokeball.svg" class="mr-3 h-8" alt="Flowbite Logo" />
                <span class="self-center whitespace-nowrap text-2xl font-semibold dark:text-white">PokeGallery</span>
            </a>
            <button
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                ...
                >
                    ...
                    <li>
                        <a
                            href="https://github.com/xBlaxk/PokeGallery"
                            target="_blank"
                    ...
                    <li>
                        <a
                            href="https://www.linkedin.com/in/gustavo-salcedov/"
                            target="_blank"
                            class="block rounded py-2 pl-3 pr-4 text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:border-0 md:p-0 md:hover:bg-transparent md:hover:text-blue-700 md:dark:hover:bg-transparent md:dark:hover:text-blue-500"
                            >Linkedin</a
                        >
